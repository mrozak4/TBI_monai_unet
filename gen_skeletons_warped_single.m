files = dir(fullfile('james_preds','*_seg_warped_single.mat'));
for k=progress(1:length(files))
    ...
    outputFileName = fullfile('james_preds',replace(basefilename,'_0001_seg_warped_single.mat','_skel_warped_single.mat'));
