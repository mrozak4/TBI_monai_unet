...
if __name__=='__main__':
    ...
    '''    
    s=np.load('/run/user/1000/gvfs/sftp:host=niagara.computecanada.ca,user=rozakmat/gpfs/fs1/home/b/bojana/rozakmat/.$SCRATCH/TBI_monai_UNET/james_preds/XYZres006_0001_seg.npy')
