        ...
        with torch.no_grad():
            ...
            if metric > best_metric:
                ...
                torch.save(model.state_dict(), os.path.join(
                    directory, "best_metric_model_ctd.pth"))
...
df.to_csv(directory + '/metrics_loss_contd.csv')
df = pd.DataFrame()
...
df.to_csv(directory + '/metrics_validation_round_2.csv')
...
plt.xlabel("epoch")
plt.plot(x, y)
plt.savefig(directory +'ipynb_trial_Val_Loss+Dice_contd.png')
