files = dir(fullfile('james_preds','*_seg_warped_single_baseline.mat'));
for k=progress(1:length(files))
    ...
    outputFileName = fullfile('james_preds',replace(basefilename,'_seg_warped_single_baseline.mat','_skel_warped_single_baseline.mat'));
